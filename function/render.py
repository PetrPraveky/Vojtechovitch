...
class Render(funcs.Func):    
    ...
    def render_graph_function(self):
        ...
        render_gf_input_btn2_5 = Button(render_gf_frame, padx=10, pady=6, text="×", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('oper', "DIV"))
        render_gf_input_btn2_6 = Button(render_gf_frame, padx=11, pady=6, text="/", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('oper', "MUL"))
