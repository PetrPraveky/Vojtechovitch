...
class Render(funcs.Func):    
    ...
    def render_main(self, mode, option):
        ...
        render_main_frame.grid_columnconfigure(0, weight=0)
        render_main_frame.grid_columnconfigure(1, weight=1)
        ...
        render_upper_bar_frame.grid(row = 0, column=0, sticky='ew', columnspan=2)
    ...
    def render_basic_calculator(self):
        ...
        global render_bc_button_1_5, render_bc_button_2_5, render_bc_button_3_5, render_bc_button_4_7
        calculator_option = 0
        ...
        render_bc_button_1_6 = Button(render_bc_frame, padx=2, pady=6, text=" log ", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('func', 'LOG'))
        render_bc_button_1_7 = Button(render_bc_frame, padx=8, pady=6, text="ln", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('func', 'LN'))
        #Řádek 2
        ...
        render_bc_button_2_7 = Button(render_bc_frame, padx=11, pady=6, text="|", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('add_oper', 'ABSVAL'))
        ...
        render_bc_button_3_5 = Button(render_bc_frame, padx=6, pady=6, text=" tg ", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('geom', 'TG'))
        ...
        render_bc_button_3_7 = Button(render_bc_frame, padx=10, pady=6, text="e", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('snum', 'e'))
        #Řádek 4
        ...
        render_bc_button_4_5 = Button(render_bc_frame, padx=11, pady=6, text="=", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('equal', 'eq'))
        render_bc_button_4_6 = Button(render_bc_frame, padx=6, pady=6, text="°'''", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('equal', 'deg'))
        render_bc_button_4_7 = Button(render_bc_frame, padx=9, pady=6, text="π", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command= lambda: self.func_calc_input('snum', 'pi'))
        #Vykreslení tlačítek
        #Řádek 0
        ...
        render_bc_button_2_7.grid(row=4, column=7, sticky='W', padx=5, pady=5)
        #Řádek 3
        ...
        render_bc_button_3_7.grid(row=5, column=7, sticky='W', padx=5, pady=5)
        #Řádek 4
        ...
        render_bc_button_4_7.grid(row=6, column=7, sticky='W', padx=5, pady=5)
    ...
    def render_BC_memory(self):
        ...
        render_bc_memory_slot_1 = Label(render_bc_memory_frame, text=(str(funcs.BC_num_memory[0])+"  =  "+str(funcs.BC_equal_memory[0])), fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, 
                                        activeforeground=main_text_color, width=28, relief='flat', borderwidth=0, anchor='e', state='disabled', disabledforeground=main_text_color, pady=5, padx=1)
    ...
    def render_graph_function(self):
        global render_gf_frame, calculator_option, render_gf_entry_1_2_6
        calculator_option = 2
        #Vytvoření základního rámu okna
        ...
        render_gf_input_btn1_1 = Button(render_gf_frame, padx=10, pady=6, text="x", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input("var", "x"))
        ...
        render_gf_input_btn1_7 = Button(render_gf_frame, padx=10, pady=6, text="←", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_clear("back"))
        render_gf_input_btn1_8 = Button(render_gf_frame, padx=10, pady=6, text="C", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_clear("C"))
        ...
        render_gf_input_btn2_1 = Button(render_gf_frame, padx=10, pady=6, text="y", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input("var", "y"))
        ...
        render_gf_input_btn2_5 = Button(render_gf_frame, padx=10, pady=6, text="×", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('oper', "MUL"))
        render_gf_input_btn2_6 = Button(render_gf_frame, padx=11, pady=6, text="/", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('oper', "DIV"))
        ...
        render_gf_input_btn3_3 = Button(render_gf_frame, padx=11, pady=6, text="7", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 7))
        render_gf_input_btn3_4 = Button(render_gf_frame, padx=11, pady=6, text="8", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 8))
        render_gf_input_btn3_5 = Button(render_gf_frame, padx=11, pady=6, text="9", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 9))
        render_gf_input_btn3_6 = Button(render_gf_frame, padx=11, pady=6, text="-", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('oper', "SUB"))
        ...
        render_gf_input_btn3_8 = Button(render_gf_frame, padx=11, pady=6, text="!", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('oper', "FAC"))
        ...
        render_gf_input_btn4_3 = Button(render_gf_frame, padx=11, pady=6, text="4", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 4))
        render_gf_input_btn4_4 = Button(render_gf_frame, padx=11, pady=6, text="5", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 5))
        render_gf_input_btn4_5 = Button(render_gf_frame, padx=11, pady=6, text="6", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 6))
        render_gf_input_btn4_6 = Button(render_gf_frame, padx=10, pady=6, text="+", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('oper', "ADD"))
        ...
        render_gf_input_btn4_8 = Button(render_gf_frame, padx=0, pady=6, text="10^x", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', "E"))
        render_gf_input_btn4_9 = Button(render_gf_frame, padx=10, pady=6, text="e", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('snum', "e"))
        ...
        render_gf_input_btn5_2 = Button(render_gf_frame, padx=11, pady=6, text="0", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 0))
        render_gf_input_btn5_3 = Button(render_gf_frame, padx=11, pady=6, text="1", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 1))
        render_gf_input_btn5_4 = Button(render_gf_frame, padx=11, pady=6, text="2", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 2))
        render_gf_input_btn5_5 = Button(render_gf_frame, padx=11, pady=6, text="3", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('num', 3))
        ...
        render_gf_input_btn5_9 = Button(render_gf_frame, padx=9, pady=6, text="π", fg=main_text_color, bg=calc_background_color_2, activebackground=calc_background_color_2_hover, activeforeground=main_text_color, cursor='hand2', command=lambda: self.func_gf_input('snum', 'pi'))
        #Render prvků
            #Render první řady
